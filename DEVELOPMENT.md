...
| FreeBSD (x86_64) | **Experimental** — compile-checked in CI; runtime behavior is not continuously tested. |
| Other BSDs | **Best effort** — expected to work, but neither compiled nor tested in CI. |
